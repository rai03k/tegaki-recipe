...
class EditRecipeBookScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditRecipeBookScreen> createState() => _EditRecipeBookScreenState();
}
...
class _EditRecipeBookScreenState extends ConsumerState<EditRecipeBookScreen> {
  ...
  Future<void> _updateRecipeBook() async {
    ...
    final success = await ref.read(recipeBookNotifierProvider.notifier).updateRecipeBook(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: recipeBookState.isLoading ? null : _updateRecipeBook,
