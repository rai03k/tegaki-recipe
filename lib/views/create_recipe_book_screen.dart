...
class CreateRecipeBookScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CreateRecipeBookScreen> createState() =>
      _CreateRecipeBookScreenState();
}

class _CreateRecipeBookScreenState
    extends ConsumerState<CreateRecipeBookScreen> {
  ...
  Future<void> _saveRecipeBook() async {
    ...
    if (mounted) {
      if (success) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('レシピ本を作成しました')));
        context.pop();
      } else {
        ScaffoldMessenger.of(
          context,
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed:
                          recipeBookState.isLoading ? null : _saveRecipeBook,
