...
class IngredientData {
  static const List<Ingredient> predefinedIngredients = [
    ...
    Ingredient(
      name: '玉ねぎ',
      iconPath: 'assets/icons/ingredients/onion.png',
      backgroundColor: Color(0xFFFFE4E1),
      category: '野菜',
    ),
    Ingredient(
      name: 'にんじん',
      iconPath: 'assets/icons/ingredients/carrot.png',
      backgroundColor: Color(0xFFFFE4B5),
      category: '野菜',
    ),
    Ingredient(
      name: 'じゃがいも',
      iconPath: 'assets/icons/ingredients/potato.png',
      backgroundColor: Color(0xFFF5F5DC),
      category: '野菜',
    ),
    Ingredient(
      name: 'キャベツ',
      iconPath: 'assets/icons/ingredients/cabbage.png',
      backgroundColor: Color(0xFFE0FFE0),
      category: '野菜',
    ),
    Ingredient(
      name: 'レタス',
      iconPath: 'assets/icons/ingredients/lettuce.png',
      backgroundColor: Color(0xFFE0FFE0),
      category: '野菜',
    ),
    Ingredient(
      name: 'トマト',
      iconPath: 'assets/icons/ingredients/tomato.png',
      backgroundColor: Color(0xFFFFE4E1),
      category: '野菜',
    ),
    Ingredient(
      name: 'きゅうり',
      iconPath: 'assets/icons/ingredients/cucumber.png',
      backgroundColor: Color(0xFFE0FFE0),
      category: '野菜',
    ),
